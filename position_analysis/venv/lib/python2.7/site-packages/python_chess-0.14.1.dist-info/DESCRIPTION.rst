...
.. image:: https://travis-ci.org/niklasf/python-chess.svg?branch=v0.14.1
...
.. image:: https://readthedocs.org/projects/python-chess/badge/?version=v0.14.1
    :target: https://python-chess.readthedocs.io/en/v0.14.1/
...
* `Core <https://python-chess.readthedocs.io/en/v0.14.1/core.html>`_
* `PGN parsing and writing <https://python-chess.readthedocs.io/en/v0.14.1/pgn.html>`_
* `Polyglot opening book reading <https://python-chess.readthedocs.io/en/v0.14.1/polyglot.html>`_
* `Gaviota endgame tablebase probing <https://python-chess.readthedocs.io/en/v0.14.1/gaviota.html>`_
* `Syzygy endgame tablebase probing <https://python-chess.readthedocs.io/en/v0.14.1/syzygy.html>`_
* `UCI engine communication <https://python-chess.readthedocs.io/en/v0.14.1/uci.html>`_
* `Changelog <https://python-chess.readthedocs.io/en/v0.14.1/changelog.html>`_
...
* Read Polyglot opening books.
  `Docs <https://python-chess.readthedocs.io/en/v0.14.1/polyglot.html>`__.
...
* Read and write PGNs. Supports headers, comments, NAGs and a tree of
  variations.
  `Docs <https://python-chess.readthedocs.io/en/v0.14.1/pgn.html>`__.
...
* Probe Gaviota endgame tablebases (DTM, WDL).
  `Docs <https://python-chess.readthedocs.io/en/v0.14.1/gaviota.html>`__.
...
* Probe Syzygy endgame tablebases (DTZ, WDL).
  `Docs <https://python-chess.readthedocs.io/en/v0.14.1/syzygy.html>`__.
...
* Communicate with an UCI engine.
  `Docs <https://python-chess.readthedocs.io/en/v0.14.1/uci.html>`__.
